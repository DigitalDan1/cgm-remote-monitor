...
function init (client, d3) {
  ...
  function calcTreatmentRadius (treatment, opts, carbratio) {
    ...
    var R1 = 0 //Math.sqrt(carbsOrInsulin) / opts.scale
      , R2 = R1
  ...
  function prepareArc (treatment, radius, renderBasal) {
    var arc_data = [
      ...
      , { 'element': '', 'color': 'transparent', 'start': -0.0032, 'end': 0.0032, 'inner': radius.R2, 'outer': radius.R3, 'textColor': '#FB8C00FF' },
      ...
      { 'element': '', 'color': 'transparent', 'start': 3.1400, 'end': 3.1432, 'inner': radius.R2, 'outer': radius.R3, 'textColor': '#0099ff' }
      , { 'element': '', 'color': 'transparent', 'start': 3.1400, 'end': 3.1432, 'inner': radius.R2, 'outer': radius.R4, 'textColor': '#0099ff' }
    ]
      , arc_data_1_elements = [];
    ...
    if (opts.showLabels) {
      ...
      label.append('text')
        ...
        .attr('transform', function(d) {
          ...
          return 'translate(' + arc.svg.centroid(d) + ') rotate(-90)';
        })
        .text(function(d) {
          return d.element;
        });
